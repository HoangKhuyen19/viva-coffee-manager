...
var UserService = /** @class */ (function () {
    ...
    //Methods:
    UserService.prototype.getByFilter = function (filter, path) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, this.multiDataToUser(usersData, path)];
                    case 4:
                        users = _a.sent();
                        return [3 /*break*/, 6];
                    case 5:
    ...
    UserService.prototype.get = function (username, path) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.trys.push([4, 6, , 7]);
                        return [4 /*yield*/, this.dataToUser(userData, path)];
                    case 5:
                        user = _a.sent();
                        return [3 /*break*/, 7];
                    case 6:
    ...
    UserService.prototype.getAll = function (path) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    UserService.prototype.dataToUser = function (data, path) {
        return __awaiter(this, void 0, void 0, function () {
            //Local function
            function precheck(username, path) {
            ...
            function getOrders(username, userT, path) {
                return __awaiter(this, void 0, void 0, function () {
                    var _a, error_11;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                _b.trys.push([1, 3, , 4]);
                                _a = userT;
                                return [4 /*yield*/, seft.orderService.getByFilter({ createdBy: username }, path)];
                            case 2:
                                _a.Orders = _b.sent();
                                return [3 /*break*/, 4];
                            case 3:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, getOrders(data.username, user, path)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    UserService.prototype.multiDataToUser = function (data, path) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Object.defineProperty(UserService.prototype, "OrderService", {
        //Getter setter
        get: function () {
