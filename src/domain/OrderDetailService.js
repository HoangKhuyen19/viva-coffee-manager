...
var OrderDetailService = /** @class */ (function () {
    ...
    OrderDetailService.prototype.get = function (orderId, product, path) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.trys.push([4, 6, , 7]);
                        return [4 /*yield*/, this.dataToOrderDetail(data, path)];
                    case 5:
                        orderDetail = _a.sent();
                        return [3 /*break*/, 7];
                    case 6:
    ...
    OrderDetailService.prototype.getAll = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, this.multiDataToOrderDetail(datas, path)];
                    case 4:
    ...
    OrderDetailService.prototype.getByFilter = function (filter, path) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    //Local methods
    OrderDetailService.prototype.dataToOrderDetail = function (data, path) {
        return __awaiter(this, void 0, void 0, function () {
            //Local function
            function precheck(orderId, product, path) {
                var _a, _b;
                for (var _i = 0, path_1 = path; _i < path_1.length; _i++) {
                    var obj = path_1[_i];
                    if (obj instanceof OrderDetail_1.default) {
                        if (((_a = obj.OrderId) === null || _a === void 0 ? void 0 : _a.Id) === orderId && ((_b = obj.Product) === null || _b === void 0 ? void 0 : _b.Id) === product) {
                            return obj;
                        }
                    }
                }
            }
            function getOrder(id, orderDetail, path) {
                return __awaiter(this, void 0, void 0, function () {
                    var _a, error_11;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                _b.trys.push([1, 3, , 4]);
                                _a = orderDetail;
                                return [4 /*yield*/, seft.orderService.get(id, path)];
                            case 2:
                                _a.OrderId = _b.sent();
                                return [3 /*break*/, 4];
                            case 3:
            ...
            function getProduct(id, orderDetail, path) {
                return __awaiter(this, void 0, void 0, function () {
                    var _a, error_12;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                _b.trys.push([1, 3, , 4]);
                                _a = orderDetail;
                                return [4 /*yield*/, seft.productService.get(id, path)];
                            case 2:
                                _a.Product = _b.sent();
                                return [3 /*break*/, 4];
                            case 3:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, getOrder(data.orderId, orderDetail, path)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, getProduct(data.product, orderDetail, path)];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 5];
                    case 4:
    ...
    OrderDetailService.prototype.multiDataToOrderDetail = function (datas, path) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Object.defineProperty(OrderDetailService.prototype, "OrderService", {
        //Getter setter
        get: function () {
            return this.orderService;
        },
        set: function (orderService) {
            this.orderService = orderService;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(OrderDetailService.prototype, "ProductService", {
        get: function () {
