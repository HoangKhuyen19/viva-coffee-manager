...
exports.ProductTypeDBHandler = void 0;
var ProductTypeData_1 = require("../dtos/ProductTypeData");
var DBHandler_1 = require("./DBHandler");
//CollectionName:
var collectionName = "ProductType";
//Pattern
var pattern = ProductTypeData_1.productTypeDataPattern;
var ProductTypeDBHandler = /** @class */ (function () {
    //Constructor:
    function ProductTypeDBHandler() {
    }
    //Methods
    ProductTypeDBHandler.prototype.get = function (id) {
    ...
    ProductTypeDBHandler.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ProductTypeDBHandler.prototype.getByFilter = function (filter) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ProductTypeDBHandler.prototype.insert = function (target) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ProductTypeDBHandler.prototype.update = function (target) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ProductTypeDBHandler.prototype.delete = function (filter) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, collection.deleteOne({ id: filter })];
                    case 4:
                        _b.sent();
                        return [3 /*break*/, 6];
                    case 5:
    ...
    return ProductTypeDBHandler;
}());
exports.ProductTypeDBHandler = ProductTypeDBHandler;
